...
- **Custom logo** (`client/src/components/Logo.tsx`) — a hand-authored SVG "TF" monogram + wordmark, recreated purely from visual analysis of a reference image (no source file was ever available), used in `AppShell`, `LoginPage`, and `public/favicon.svg`.
