...
```powershell
npm test                       # server Jest+Supertest suite (48 tests across auth/cases/suites/projects/runs/plans/milestones/csv/webhooks/me/defects)
```
